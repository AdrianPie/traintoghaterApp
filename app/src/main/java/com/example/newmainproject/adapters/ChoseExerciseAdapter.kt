...
class ChoseExerciseAdapter(
    private val exerciseList: ArrayList<Exercise>,
    private val listener: OnItemClickListener
    ) :
    RecyclerView.Adapter<ChoseExerciseAdapter.ViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChoseExerciseAdapter.ViewHolder {
    ...
    OnClickListener{
        ...
        override fun onClick(v: View?) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                listener.onItemClickTwo(position)
            }
